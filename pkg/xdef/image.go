...
const (
	...
	// build target the image was built from. It is one of the names listed in
	// [EnvBldImgTargets] and is passed to the build as a build argument. The
	// OCI Image Spec has no annotation for it, so the label stamping it, if
	// any, is named by the code building the image.
	//
	// Example: second
